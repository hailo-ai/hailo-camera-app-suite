...
public:
    ...
    void set_cors();
    void set_exception_handler(const ExceptionHandler& excpetion_handler);
};
...
void HTTPServer::set_exception_handler(const ExceptionHandler& excpetion_handler)
{
    m_impl->set_exception_handler(excpetion_handler);
}
